...
import (
	"github.com/maki5/gokogiri/html"
	"github.com/maki5/gokogiri/xml"
)
...
found in the github.com/maki5/gokogiri/xml package. The xml.StrictParsingOption is conveniently provided for standards-compliant
behaviour.
*/
